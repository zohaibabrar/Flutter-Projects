...
class AddSoapItemScreen extends StatefulWidget {
  const AddSoapItemScreen({Key? key}) : super(key: key);

  @override
  State<AddSoapItemScreen> createState() => _AddSoapItemScreenState();
}

class _AddSoapItemScreenState extends State<AddSoapItemScreen> {
  bool itemAvaialble = true;
  final _itemNameController = TextEditingController();
  final _itemPriceController = TextEditingController();
  final _itemQuantityController = TextEditingController();

  Future addSoapItemDetails(String itemName, int itemPrice, bool itemAvailable,
