...
class AddSkinCareItemScreen extends StatefulWidget {
  const AddSkinCareItemScreen({Key? key}) : super(key: key);

  @override
  State<AddSkinCareItemScreen> createState() => _AddSkinCareItemScreenState();
}

class _AddSkinCareItemScreenState extends State<AddSkinCareItemScreen> {
  bool itemAvaialble = true;
  final _itemNameController = TextEditingController();
  final _itemPriceController = TextEditingController();
  final _itemQuantityController = TextEditingController();

  Future addSkinCareItemDetails(String itemName, int itemPrice,
