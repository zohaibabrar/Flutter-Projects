...
class AddDryFruitsItemScreen extends StatefulWidget {
  const AddDryFruitsItemScreen({Key? key}) : super(key: key);

  @override
  State<AddDryFruitsItemScreen> createState() => _AddDryFruitsItemScreenState();
}

class _AddDryFruitsItemScreenState extends State<AddDryFruitsItemScreen> {
  bool itemAvaialble = true;
  final _itemNameController = TextEditingController();
  final _itemPriceController = TextEditingController();
  final _itemQuantityController = TextEditingController();

  Future addDryFruitItemDetails(String itemName, int itemPrice,
