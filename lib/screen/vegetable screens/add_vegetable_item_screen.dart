...
class AddVegetablesItemScreen extends StatefulWidget {
  const AddVegetablesItemScreen({Key? key}) : super(key: key);

  @override
  State<AddVegetablesItemScreen> createState() =>
      _AddVegetablesItemScreenState();
}

class _AddVegetablesItemScreenState extends State<AddVegetablesItemScreen> {
  bool itemAvaialble = true;
  final _itemNameController = TextEditingController();
  final _itemPriceController = TextEditingController();
  final _itemQuantityController = TextEditingController();

  Future addVegetablesItemDetails(String itemName, int itemPrice,
