...
class AddBeverageItemScreen extends StatefulWidget {
  const AddBeverageItemScreen({Key? key}) : super(key: key);

  @override
  State<AddBeverageItemScreen> createState() => _AddBeverageItemScreenState();
}

class _AddBeverageItemScreenState extends State<AddBeverageItemScreen> {
  bool itemAvaialble = true;
  final _itemNameController = TextEditingController();
  final _itemPriceController = TextEditingController();
  final _itemQuantityController = TextEditingController();

  Future addBeverageItemDetails(String itemName, int itemPrice,
