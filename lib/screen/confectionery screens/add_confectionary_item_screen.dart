...
class AddConfectioneryItemScreen extends StatefulWidget {
  const AddConfectioneryItemScreen({Key? key}) : super(key: key);

  @override
  State<AddConfectioneryItemScreen> createState() =>
      _AddConfectioneryItemScreenState();
}

class _AddConfectioneryItemScreenState
    extends State<AddConfectioneryItemScreen> {
  bool itemAvaialble = true;
  final _itemNameController = TextEditingController();
  final _itemPriceController = TextEditingController();
  final _itemQuantityController = TextEditingController();

  Future addConfectioneryItemDetails(String itemName, int itemPrice,
