...
class GetVegetablesItemDetails extends StatefulWidget {
  final String vegetableItemId;

  const GetVegetablesItemDetails({
    Key? key,
    required this.vegetableItemId,
  }) : super(key: key);

  @override
  State<GetVegetablesItemDetails> createState() =>
      _GetVegetablesItemDetailsState();
}

class _GetVegetablesItemDetailsState extends State<GetVegetablesItemDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference vegetable = FirebaseFirestore.instance
    ...
    return FutureBuilder<DocumentSnapshot>(
      future: vegetable.doc(widget.vegetableItemId).get(),
