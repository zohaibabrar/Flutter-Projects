...
class GetSoapItemDetails extends StatefulWidget {
  final String soapItemId;

  const GetSoapItemDetails({
    Key? key,
    required this.soapItemId,
  }) : super(key: key);

  @override
  State<GetSoapItemDetails> createState() => _GetSoapItemDetailsState();
}

class _GetSoapItemDetailsState extends State<GetSoapItemDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference soap = FirebaseFirestore.instance
    ...
    return FutureBuilder<DocumentSnapshot>(
      future: soap.doc(widget.soapItemId).get(),
